    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse nav-pos" id="Navbar">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown nav-element-left"><a class="nav-link drop-down-toggle" href="#" id="navbardrop" data-toggle="dropdown"><span class="fa fa-user"></span> My account</a>
    ...
    <div class="container">
      ...
      <div class="tab-content"  style="background:#fff">
        <div role="tabpanel" class="tab-pane fade show active" id="question">
          <h3>Question <small><?php echo $pid; ?></small></h3>
     ...
     <div class="container" style="margin:50px auto">
      <h2>Input</h2>
	  <p>Do not include any header files</p>
