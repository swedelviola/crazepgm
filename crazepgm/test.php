    ...
    <div class="container">
      <div class="row row-header">
        <div class="col-12 col-sm-6">
          <h1>ERROR:</h1><br><br>
          <h4>TRYING TO BYPASS NORMAL FLOW OF WEBSITE or selected invalid question id</h4>
          <br><br>
          <h5>To go back to the Index page</h5>
          <a href="index.php"><button style="margin-left: 50%">Click here</button></a>
